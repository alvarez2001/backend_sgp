    ...
    implements AuthenticationReadRepositoryInterface
{
    ...
    async create(authentication: CreateAuthenticationDto): Promise<AuthenticationRead> {
    ...
    async update(id: number, authentication: UpdateAuthenticationDto): Promise<AuthenticationRead> {
