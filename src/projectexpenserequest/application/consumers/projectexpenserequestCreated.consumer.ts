...
@Injectable()
export class ProjectExpenseRequestCreatedConsumer implements OnModuleInit {
    ...
    private async handleMessage(msg: ConsumeMessage): Promise<void> {
        try {
            ...
            if (
                ...
                data.displayNames[DeclarationQueues.projectexpenserequest_created] === ProjectExpenseRequestCreatedConsumer.name
            ) {
            }
