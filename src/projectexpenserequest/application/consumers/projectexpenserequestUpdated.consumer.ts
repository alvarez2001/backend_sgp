...
@Injectable()
export class ProjectExpenseRequestUpdatedConsumer implements OnModuleInit {
    ...
    private async handleMessage(msg: ConsumeMessage): Promise<void> {
        try {
            ...
            if (
                ...
                data.displayNames[DeclarationQueues.projectexpenserequest_updated] === ProjectExpenseRequestUpdatedConsumer.name
            ) {
            }
